...
s.strip() - odstrani medzery na začiatku a na konci retazca a tie aj ine oddelovace, napr. /n
s.split() - rozdeli retazec na casti podla uvedeneho oddelovacieho znaku a vytvori zoznam stringov
